export const users = [
  {
    ...
    placeCount: 8,
    description:
      "I like new places and i am fat so lets go wtf am i saying anymore",
  },
  {
    id: 1,
    image:
    ...
    placeCount: 8,
    description:
      "I like new places and i am fat so lets go wtf am i saying sdf sdf sdf sd f sdf sdf s df sdf sd f sdf sd fs df sdf sd f sd sdf d fs df sdf s df sdf sdf sd f sdf sd fs df sdf sd f sdf ",
  },
  {
    id: 2,
    image:
